...
From here on out you will make changes to the project and make commits using git. Eventually you will want to upload online so that other users can see your changes, in this case you will run 
