...
\input{logic/definitions/language_of_number_theory}

\input{logic/definitions/term}

\input{logic/definitions/terms_of_a_language}

\input{logic/definitions/formula}

\input{logic/definitions/formulas_of_a_language}

\input{logic/definitions/subformula}

\input{logic/definitions/scope}

\input{logic/definitions/a_term's_variable_replaced_by_a_term}

\input{logic/definitions/a_formulas_variable_replaced_by_a_term}
...
\input{logic/definitions/variable_assignment_function}

\input{logic/definitions/term_assignment_function}

\input{logic/definitions/interpretation_of_a_term}

\input{logic/definitions/satisfaction}

\input{logic/definitions/l-structure}

\input{logic/definitions/equivalent_formulas}

\input{logic/propositions/double_negation_equivalence}

\input{logic/definitions/a_literal_structure}
...
\input{logic/definitions/axioms_of_n}
...
\input{logic/lemmas/constant_replacement_removes_it}
...
\input{logic/propositions/finite_subsets_having_a_model_implies_original_set_does}

\input{logic/propositions/sentences_which_force_an_infinite_model}

\input{logic/definitions/theory_of_a_structure}


\section{Incompleteness}

\input{logic/definitions/a_set_of_non-logical_axioms_are_complete}

\input{logic/definitions/bounded_quantifier_abbreviations}

\input{logic/definitions/sigma_formula}

\input{logic/definitions/pi_formula}

\input{logic/propositions/negation_of_a_sigma_formula_is_a_pi_formula}


\input{logic/definitions/delta_formula}


\input{logic/definitions/representable_set}

\input{logic/propositions/union_and_intersection_of_two_representable_sets_is_still_representable}
...
\input{logic/propositions/subset_of_n_is_representable_iff_it's_characteristic_function_is}

\input{logic/propositions/the_set_of_representable_functions_is_countable}

\input{logic/examples/an_unrepresentable_function}

\input{logic/propositions/representable_function_criterion}

\input{logic/definitions/definable_set}

\input{logic/corollaries/definable_by_delta_formula_implies_representable}

\input{logic/definitions/symbol_numbers_for_the_language_of_number_theory}

\input{logic/definitions/gödel_numbering}

\input{logic/definitions/term_construction_sequence}

\input{logic/definitions/formula_construction_sequence}
